...
artist: "理芽"
type: "ライブアルバム"
description: "理芽の正式リリース『CHOCOLATE LIVE2』。全曲順を確認し、各楽曲ページへリンクしています。"
...
『CHOCOLATE LIVE2』は本カタログに収録する正式リリースです。発売日、曲順、収録時間、参加アーティストは公式ディスコグラフィーとApple Music日本版を照合しています。
...
- [公式ディスコグラフィー](https://kamitsubaki.jp/discography/rim/3170/)
