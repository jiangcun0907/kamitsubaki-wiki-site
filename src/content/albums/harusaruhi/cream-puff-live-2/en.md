...
artist: "Harusaruhi"
type: "Live album"
description: "CREAM PUFF LIVE 2, an official Harusaruhi release with a verified track list and song links."
...
CREAM PUFF LIVE 2 is an official release represented in this catalog. Release date, track order, durations, and credited performers were cross-checked against the official discography and Apple Music Japan.

## Tracks and versions

This page lists 30 tracks. MC segments remain in the track list without separate song pages; every musical track links to a dedicated song or version entry. Reissues reuse one entry, while live, remix, and rearranged versions remain distinct.
