...
- 白丸（CV：？？？[<span style="filter: blur(5px); transition: filter 0.3s; cursor: pointer;" onmouseover="this.style.filter='none'" onmouseout="this.style.filter='blur(5px)'" onclick="this.style.filter='none'">ヰ世界情绪</span>](https://kamitsubaki.wiki/zh/artists/vwp/isekaijoucho/)）
- 魔王（CV：诗道）
